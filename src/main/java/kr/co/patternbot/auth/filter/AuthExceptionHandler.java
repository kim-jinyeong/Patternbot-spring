...
import kr.co.patternbot.auth.exception.ErrorCode;
import kr.co.patternbot.auth.exception.LoginRunnerException;
...
public class AuthExceptionHandler {
    ...
    protected ResponseEntity<Messenger> handleRuntimeException(RuntimeException e){
        ...
        Messenger response = Messenger.builder().code("test")
